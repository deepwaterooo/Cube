...
\label{sec-1}
\begin{itemize}
\item textures basically done, trying to render and display six different images for six surfaces, working on it.
...
\item 6 textu \url{https://www.youtube.com/watch?v=rpq8aNKNLxA}
\item 
\item 
...
\item 程序猿 android apiApp a series of app tutorial examples, google if needed for references
\end{itemize}
